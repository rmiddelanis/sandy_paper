...
fig, ax = plt.subplots(figsize=(MAX_FIG_WIDTH_WIDE * 0.84559, MAX_FIG_WIDTH_WIDE * 0.56 * 0.84559))
...
# ax.axis('scaled')
plt.tight_layout()
fig.savefig("../figures/conceptual_fig_wo_USA-OTH_rescaled_for_diss.pdf", dpi=300)
plt.show()